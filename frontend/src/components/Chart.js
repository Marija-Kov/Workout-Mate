...
export const Chart = () => {
   ...
   const { chest, shoulder, biceps, triceps, leg, back, glute, ab, calf, forearmAndGrip } = useSelector(state => state.routineBalance)
   const muscleGroups = useMemo(() => allUserWorkoutsMuscleGroups, [allUserWorkoutsMuscleGroups])
   useEffect(() => {

...
export const loaderReducer = (state = init, action) => {
    switch(action.type) {
        case SET_WORKOUTS_LOADER: return {
            ...state,
            workouts: true
        };
        case UNSET_WORKOUTS_LOADER: return {
            ...state,
            workouts: false
        };
        case SET_USER_LOADER: return {
            ...state,
            user: true
        };
        case UNSET_USER_LOADER: return {
            ...state,
            user: false
        };
        case SET_CHART_LOADER: return {
            ...state,
            chart: true
        };
        case UNSET_CHART_LOADER: return {
            ...state,
            chart: false
        };
        case UNSET_ALL_LOADERS: return init;
        default: return init
    }
}
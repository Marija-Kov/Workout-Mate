...
describe("useConfirmAccount()", () => {
 ...
 it("should set confirmAccountError message given that token is invalid", async () => {
    ...
    expect(state.user.confirmAccountError).toMatch(/invalid account confirmation token/i); 
   });
 ...
 it("should set confirmAccountError message given that token is not found", async () => {
    ...
    let state = store.getState();
    expect(state.user.confirmAccountError).toBeTruthy(); 
    expect(state.user.confirmAccountError).toMatch(/account confirmation token not found/i); 
   });
